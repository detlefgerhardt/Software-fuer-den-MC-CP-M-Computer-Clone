...
**NFORM** ist die Reimplementierung in C. Aktuell noch als Test-Version mit hardcodierten Parametern und nur für NDR-Format (800K Mini-Disk). Unterstützt Interleaving (Skew-Faktor)
