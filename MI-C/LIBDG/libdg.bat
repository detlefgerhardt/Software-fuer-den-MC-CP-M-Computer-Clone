...
CPM LIB80 LIBDG=MEMSET,MEMCPY,OUTP,INP,CONIO,CGETS,RANDOM/E > libdg.lerr

MICERR conio.cerr conio.merr fgets.cerr fgets.merr random.cerr random.merr memset.merr memcpy.merr outp.merr inp.merr libdg.lerr
